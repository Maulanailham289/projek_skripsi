...
<div id="popup-create" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 max-h-[80vh] overflow-y-auto">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('ekspor.store') }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">

                    <!-- Tanggal Ekspor -->
                    <div class="col-span-2">
                        <label for="tanggal_ekspor"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Ekspor</label>
                        <input type="date" name="tanggal_ekspor" id="tanggal_ekspor"
                    ...
                    <!-- Negara Tujuan -->
                    <div class="col-span-2">
                        <label for="negara_tujuan"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Negara Tujuan</label>
                    ...
                    <div class="col-span-2">
                        <label for="product_id"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Komoditas / Nama Produk</label>
                    ...
                    <!-- Volume Ekspor -->
                    <div class="col-span-2">
                        <label for="volume_ekspor"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Volume Ekspor (kg)</label>
                        <input type="number" name="volume_ekspor" id="volume_ekspor" step="0.01"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            placeholder="Masukkan volume dalam kg" required>
                    </div>

                    <!-- Harga Awal -->
                    <div class="col-span-2">
                        <label for="biaya_produksi"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Awal (Rp)</label>
                    ...
                    <div class="col-span-2">
                        <label for="laba_bersih"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Laba Bersih (Rp)</label>
                        <input type="number" name="laba_bersih" id="laba_bersih"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
